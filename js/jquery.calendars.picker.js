	...
	alert('Now in ' + month + '/' + year);
 	...
 	alert('Selected ' + dates);
		...
		/** Localisations for the plugin.
			...
			@property [prevText='←'] {string} Text for the previous month command.
			@property [prevStatus='Bekijk de vorige maand] {string} Status text for the previous month command.
			@property [prevJumpText='«'] {string} Text for the previous year command.
			@property [prevJumpStatus='Bekijk het vorig jaar'] {string} Status text for the previous year command.
			@property [nextText='→'] {string} Text for the next month command.
			@property [nextStatus='Bekijk de volgende maand'] {string} Status text for the next month command.
			@property [nextJumpText='»'] {string} Text for the next year command.
			@property [nextJumpStatus='Bekik het volgende jaar'] {string} Status text for the next year command.
			@property [currentText='Vandaag'] {string} Text for the current month command.
			@property [currentStatus='Bekijk de huidige maand'] {string} Status text for the current month command.
			@property [todayText='Vandaag'] {string} Text for the today's month command.
			@property [todayStatus='Bekijk deze maand'] {string} Status text for the today's month command.
			@property [clearText='Wissen'] {string} Text for the clear command.
			@property [clearStatus='Wis alle datums'] {string} Status text for the clear command.
			@property [closeText='Sluiten'] {string} Text for the close command.
			@property [closeStatus='Sluit de datepicker'] {string} Status text for the close command.
			@property [yearStatus='Verander het jaar'] {string} Status text for year selection.
			@property [earlierText='&#160;&#160;▲'] {string} Text for earlier years.
			@property [laterText='&#160;&#160;▼'] {string} Text for later years.
			@property [monthStatus='Verander de maand'] {string} Status text for month selection.
			@property [weekText='Wk'] {string} Text for week of the year column header.
			@property [weekStatus='Week van het jaar'] {string} Status text for week of the year column header.
			@property [dayStatus='dd-mm-yyyy'] {string} Status text for selectable days.
			@property [defaultStatus='Selecteer een datum'] {string} Status text shown by default.
		...
		regionalOptions: { // Available regional settings, indexed by language/country code
			'': { // Default regional settings - English/US
				...
				todayText: 'Vandaag',
				todayStatus: 'Bekijk deze maand',
				clearText: 'Wissen',
				clearStatus: 'Wis alle datums',
				closeText: 'Sluiten',
				closeStatus: 'Sluit de datepicker',
				yearStatus: 'Verander het jaar',
				earlierText: '&#160;&#160;▲',
				laterText: '&#160;&#160;▼',
				monthStatus: 'Verander de maand',
				weekText: 'Wk',
				weekStatus: 'Week van het jaar',
				dayStatus: 'dd-mm-yyyy',
				defaultStatus: 'Selecteer een datum',
				isRTL: false
			}
		},
