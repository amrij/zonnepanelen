...
class MoonPhase {
	...
	*/
	...
	function phase_name() {
		$names = array( 'Nieuwe maan', 'Jonge maan', 'Eerste kwartier', 'Wassende maan', 'Volle maan', 'Afnemende maan', 'Laatste kwartier', 'Asgrauwe maan', 'Nieuwe maan' );
		...
		return $names[ floor( ( $this->phase + 0.06 ) * 8 ) ];
	}
}